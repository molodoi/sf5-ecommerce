...
class ResetPasswordController extends AbstractController
{
     ...
     */
    public function index(Request $request, Mailjet $mail): Response
    {
        if ($this->getUser()) {
        ...
        if ($request->get('email')) {
            ...
            if ($user) {
                ...
                $mail->send($user->getEmail(), $user->getFirstname().' '.$user->getLastname(), 'Réinitialiser votre mot de passe', 'Réinitialiser votre mot de passe', $content);
